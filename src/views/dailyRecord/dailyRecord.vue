  ...
  <div class="record">
    ...
    <div class="record_wrapper">
      ...
      <div class="record_title">
        <div class="tipCircle" v-for="(item, index) in state.tipCircleList" :key="index"
          :style="item.active === true ? 'background-color: ' + item.bgColor + ';' : ''"
          @click="showDailyRecord(item.num)"></div>
      </div>
      <!-- 便签输入模块 -->
      <div :class="recordMainCSSChange">
        <!-- 输入 -->
        <div class="record_input">
          <el-input v-model="textarea2" type="textarea" :show-word-limit='false' placeholder="Please input"
            @blur="submit" />
        </div>
